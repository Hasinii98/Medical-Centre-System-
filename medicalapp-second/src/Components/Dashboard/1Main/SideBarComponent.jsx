                ...
                <ul class="nav flex-column">
                    ...
                    <li class = "nav-item dropdown">
   				        ...
   				        <ul class="collapse list-unstyled" id="labDrop">
   					        <li> <a class = "dropdown-item" href="/lab/add-labDetails">New Lab Report</a> </li>
                               <li> <a class = "dropdown-item" href="#">All Lab Tests</a> </li>
                            <li> <a class = "dropdown-item" href="/lab/lab-report">All Lab Reports</a> </li>
                            <li> <a class = "dropdown-item" href="/lab-equipment/equipments">All Equipments</a> </li>
                            <li> <a class = "dropdown-item" href="/lab-equipment/add-equipment">Add Equipment</a> </li>
