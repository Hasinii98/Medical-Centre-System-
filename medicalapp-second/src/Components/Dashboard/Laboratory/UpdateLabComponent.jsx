                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="form-group">
                                            <label>Lab ID</label>
                                            <input placeholder="Lab ID"  readOnly= {true} name="labId" className="form-control"
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input placeholder="Lab Test" name="labTest" readOnly= {true} className="form-control"
                                        ...
                                        <div className="form-group">
                                            <label>Patient</label>
                                            <input placeholder="Patient" readOnly= {true}  name="patient" className="form-control"
                                        ...
                                        <div className="form-group">
                                            <label>Gender</label>
                                            <input placeholder="Gender" name="gender" readOnly= {true}  className="form-control"
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input placeholder="Consultant" readOnly= {true}   name="consultant" className="form-control"
